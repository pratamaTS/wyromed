...
class DetailTablePesananAdapter (private var mContext: Context, mListDetailTablePesanan: ArrayList<DataDetailMessageBooking>) :
    RecyclerView.Adapter<DetailTablePesananViewHolder>() {
    private val mListDetailTablePesanan: ArrayList<DataDetailMessageBooking>
