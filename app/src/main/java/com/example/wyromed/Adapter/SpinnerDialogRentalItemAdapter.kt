...
class SpinnerDialogRentalItemAdapter(var context: Context, var dataSource: ArrayList<DataRentalItem>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            ...
            tvTitle = view.findViewById(R.id.list_rental_item)
            when(choose){
                false -> tvTitle.text = "Select Rental Item"
    ...
    override fun getItem(position: Int): DataRentalItem? {
        choose = true
